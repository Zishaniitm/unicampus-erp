...
import {
  ...
  Users, ClipboardList, BookMarked, Bus, Home
} from 'lucide-react'
...
const navItems: NavItem[] = [
  ...
  { label: 'Attendance',  to: '/attendance',  icon: <UserCheck size={18} />,        roles: ['STUDENT','TEACHER','HOD'] },
  { label: 'Fees',        to: '/fees',        icon: <CreditCard size={18} />,       roles: ['STUDENT','ACCOUNT_OFFICER','PRINCIPAL'] },
  { label: 'Library',     to: '/library',     icon: <BookOpen size={18} />,         roles: ['STUDENT','LIBRARIAN'] },
  ...
  { label: 'Grievances',  to: '/grievances',  icon: <MessageSquare size={18} />,    roles: ['STUDENT','HOD','STAFF','PRINCIPAL'] },
  ...
  return (
    <aside className="h-screen w-60 bg-primary flex flex-col shrink-0 shadow-lg">
      ...
      <nav className="flex-1 overflow-y-auto py-3 px-2">
        <p className="text-blue-300/60 text-xs font-semibold uppercase tracking-wider px-3 mb-2">Main Navigation</p>
