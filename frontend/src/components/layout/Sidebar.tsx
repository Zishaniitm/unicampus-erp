...
const navItems: NavItem[] = [
  ...
  { label: 'Hostel',            to: '/hostel',         icon: <Home size={18} />,             roles: ['STUDENT'] },
  { label: 'Bus',               to: '/bus',            icon: <Bus size={18} />,              roles: ['STUDENT'] },
  { label: 'Hostel & Bus Mgmt', to: '/hostel-bus/manage', icon: <Home size={18} />,          roles: ['STAFF','SUPER_ADMIN'] },
